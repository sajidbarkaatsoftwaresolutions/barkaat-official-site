...
import { ArrowRight, Compass, Layers, Workflow, Settings, CheckCircle, LayoutTemplate, Server, Cloud } from "lucide-react";
...
export default function ServicesSection() {
  ...
  return (
    <section className="py-12 md:py-20 px-5 md:px-10 bg-obsidian-900" id="services">
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        <h2 className="font-montserrat text-2xl md:text-3xl lg:text-[48px] font-extrabold text-text-primary mb-12 uppercase tracking-[-0.5px]">Our Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {displayedServices.map((service, idx) => {
            ...
            return (
              <div key={idx} className="bg-obsidian-800 border border-border-primary rounded-2xl p-8 transition-all duration-200 hover:border-accent-crimson hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(211,65,78,0.1)] animate-fade-in">
